...
import TrustpilotQuote from 'theme/components/hulii/blocks/Trustpilot/TrustpilotQuote'
import TrustpilotSlider from 'theme/components/hulii/blocks/Trustpilot/TrustpilotSlider'
...
export default {
  ...
  mounted () {
    // if (localStorage.getItem('newsletter-shown') <= 10) this.$bus.$emit('modal-show', 'modal-promotion')
    // this.$bus.$emit('modal-show', 'modal-promotion')
  },
  watch: {
    isLoggedIn () {
